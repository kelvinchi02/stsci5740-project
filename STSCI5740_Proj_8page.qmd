  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \AtBeginEnvironment{longtable}{\tablefont\setstretch{0.95}}
        \AtBeginEnvironment{tabular}{\tablefont\setstretch{0.95}}
        \AtBeginEnvironment{tabularx}{\tablefont\setstretch{0.95}}
